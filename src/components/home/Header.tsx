...
import btnIcon from '../../assets/img/header-btn-icon.png'
      ...
      <Container className='d-flex align-items-center justify-content-between'>
        ...
        <nav className={`heading-menu ${isMenu ? 'show-menu' : ''}`}>
          ...
          <ul className="d-lg-flex align-items-center">
            ...
            <li>
              <Link to='/login' className='btn d-i-flex d-md-none align-items-center'><img src={btnIcon} alt="" /> Lunch App</Link>
            </li>
          </ul>
        </nav>
        <div className="heading-actions d-flex align-items-center flex-wrap">
          <Link to='/login' className='btn d-flex align-items-center d-none d-md-block'><img src={btnIcon} alt="" /> Lunch App</Link>
